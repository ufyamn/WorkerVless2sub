...
// 部署完成后在网址后面加上这个，获取订阅器默认节点，/ufya

let mytoken= ['ufya'];//快速订阅访问入口, 留空则不启动快速订阅

// 设置优选地址，不带端口号默认443，TLS订阅生成
let addresses = [
	'yxym.820616.xyz#官方优选域名',
];

// 设置优选地址api接口
let addressesapi = [
	'https://raw.githubusercontent.com/ufyamn/WorkerVless2sub/main/addressesapi.txt', //可参考内容格式 自行搭建。
